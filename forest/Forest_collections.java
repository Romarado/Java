...
public abstract class Forest_collections {
	...
	public static void addToArray(int number, msgLogging msg) {
	...
	public static void removeFromArray(int number, msgLogging msg) {
	...
	public static void addToLinked(int number, msgLogging msg) {
		Timer timer = new Timer();
		msg.addLog("***********LOGGING *************");
		for(int i = 0; i<number; i++)
		{	Forest forest = randomForest();
	...
	public static void removeFromLinked(int number, msgLogging msg) {
		int startID = randomInt(0, Forests_ArrayList.size()-1-number);
		Timer timer = new Timer();
		msg.addLog("***********LOGGING *************");
		for(int i = startID; i< startID + number; i++) {
